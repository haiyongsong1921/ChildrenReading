...
import { fiveYearsOldData } from './fiveYearsOldData';

export default function FiveYearsOldPage() {
    const [currentPageIndex, setCurrentPageIndex] = useState(0);

    const currentPage = fiveYearsOldData[currentPageIndex];
    const isFirstPage = currentPageIndex === 0;
    const isLastPage = currentPageIndex === fiveYearsOldData.length - 1;
        ...
        <div className={styles.container}>
            <div className={styles.bookPage}>
                ...
                <div className={styles.pageNumber}>
                    第 {currentPage.id} 页 / 共 {fiveYearsOldData.length} 页
                </div>
            </div>
        </div>
    );
